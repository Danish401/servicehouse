...
//             image: profile.photos[0]?.value || "", // Save Google profile image
//           });
//           await user.save();
//         }
//         done(null, user);
...
//   )
// );
// passport.serializeUser((user, done) => done(null, user._id)); // Use MongoDB _id here
// passport.deserializeUser(async (id, done) => {
//   try {
//     const user = await User.findById(id); // MongoDB _id lookup
//     done(null, user);
//   } catch (err) {
//     done(err, null);
//   }
